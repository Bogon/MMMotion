...
extension String {
    ...
    subscript (r: Range<Int>) -> String {
        ...
        if r.upperBound < self.count {
            end = self.index(self.startIndex, offsetBy: r.upperBound)
        } else {
            return String(self[start ..< index(startIndex, offsetBy: self.count)])
        }
        
        return String(self[start ..< end!])
        
        //return String(self[Range.init(<#T##range: NSRange##NSRange#>, in: <#T##String#>)])   //Range(start ..< end)
    }
