...
//        register(UINib(nibName: "MMMessageFooterView", bundle: MessengerKit.bundle),
//        forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: "MMMessageFooterView")
